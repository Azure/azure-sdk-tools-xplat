...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '5216057e-5549-42f4-8873-2ba47fa66c3b',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14961',
  'x-ms-correlation-request-id': '6d890d72-41ee-431a-b7eb-134452316a82',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000639Z:6d890d72-41ee-431a-b7eb-134452316a82',
  date: 'Fri, 12 Aug 2016 00:06:39 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension8009/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?$expand=instanceView&api-version=2016-03-30')
  .reply(200, "{\r\n  \"properties\": {\r\n    \"publisher\": \"Microsoft.Compute\",\r\n    \"type\": \"VMAccessAgent\",\r\n    \"typeHandlerVersion\": \"2.0\",\r\n    \"autoUpgradeMinorVersion\": true,\r\n    \"provisioningState\": \"Succeeded\",\r\n    \"instanceView\": {\r\n      \"name\": \"VMAccessAgent\",\r\n      \"type\": \"Microsoft.Compute.VMAccessAgent\",\r\n      \"typeHandlerVersion\": \"2.3\",\r\n      \"statuses\": [\r\n        {\r\n          \"code\": \"ProvisioningState/succeeded\",\r\n          \"level\": \"Info\",\r\n          \"displayStatus\": \"Provisioning succeeded\",\r\n          \"message\": \"Plugin enabled (name: Microsoft.Compute.VMAccessAgent, version: 2.3).\"\r\n        }\r\n      ]\r\n    }\r\n  },\r\n  \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension8009/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent\",\r\n  \"name\": \"VMAccessAgent\",\r\n  \"type\": \"Microsoft.Compute/virtualMachines/extensions\",\r\n  \"location\": \"eastus\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '929',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '04b612e5-0a1d-40c5-852c-0f5c2a136967',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14959',
  'x-ms-correlation-request-id': 'e63fe557-d7c6-4cec-8190-4ca7af2a34a5',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000641Z:e63fe557-d7c6-4cec-8190-4ca7af2a34a5',
  date: 'Fri, 12 Aug 2016 00:06:41 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.azure.com:443')
  .delete('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension8009/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30')
  .reply(202, "", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '0',
  expires: '-1',
  location: 'https://management.azure.com/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/0c6ad066-e20e-4950-8698-01c57d567bc6?monitor=true&api-version=2016-03-30',
  'azure-asyncoperation': 'https://management.azure.com/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/0c6ad066-e20e-4950-8698-01c57d567bc6?api-version=2016-03-30',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '0c6ad066-e20e-4950-8698-01c57d567bc6',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1193',
  'x-ms-correlation-request-id': 'c4155174-dcdd-4b10-9014-7ffd8019f88f',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000642Z:c4155174-dcdd-4b10-9014-7ffd8019f88f',
  date: 'Fri, 12 Aug 2016 00:06:41 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
...
var result = 
nock('http://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/0c6ad066-e20e-4950-8698-01c57d567bc6?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-08-12T00:06:41.0612681+00:00\",\r\n  \"status\": \"InProgress\",\r\n  \"name\": \"0c6ad066-e20e-4950-8698-01c57d567bc6\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '134',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': 'f9028310-772a-4af9-b03d-ff025f2d768a',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14964',
  'x-ms-correlation-request-id': '5dc83cf9-0459-4ee1-9c03-1256f29605a2',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000713Z:5dc83cf9-0459-4ee1-9c03-1256f29605a2',
  date: 'Fri, 12 Aug 2016 00:07:13 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/0c6ad066-e20e-4950-8698-01c57d567bc6?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-08-12T00:06:41.0612681+00:00\",\r\n  \"endTime\": \"2016-08-12T00:07:25.0615721+00:00\",\r\n  \"status\": \"Succeeded\",\r\n  \"name\": \"0c6ad066-e20e-4950-8698-01c57d567bc6\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '184',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '94a8a6df-b596-4313-b971-2448c0c55cdf',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14958',
  'x-ms-correlation-request-id': '89b88754-7dcb-4b35-8022-0952a0868b16',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000744Z:89b88754-7dcb-4b35-8022-0952a0868b16',
  date: 'Fri, 12 Aug 2016 00:07:44 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
