...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '59c9e6a1-1c0c-4375-9304-de059a852140',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14966',
  'x-ms-correlation-request-id': 'cf6a45f3-aefa-4b2b-9051-66facaf3ad3d',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000115Z:cf6a45f3-aefa-4b2b-9051-66facaf3ad3d',
  date: 'Fri, 12 Aug 2016 00:01:14 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
.put('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension8009/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30', '*')
  .reply(200, "{\r\n  \"properties\": {\r\n    \"publisher\": \"Microsoft.Compute\",\r\n    \"type\": \"VMAccessAgent\",\r\n    \"typeHandlerVersion\": \"2.0\",\r\n    \"autoUpgradeMinorVersion\": true,\r\n    \"provisioningState\": \"Updating\"\r\n  },\r\n  \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension8009/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent\",\r\n  \"name\": \"VMAccessAgent\",\r\n  \"type\": \"Microsoft.Compute/virtualMachines/extensions\",\r\n  \"location\": \"eastus\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '501',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'azure-asyncoperation': 'https://management.azure.com/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/b5a963f0-cb65-4c2e-a072-0cd66310327c?api-version=2016-03-30',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': 'b5a963f0-cb65-4c2e-a072-0cd66310327c',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1196',
  'x-ms-correlation-request-id': '913aaeb3-3835-4781-929f-6b1c1643ddee',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000116Z:913aaeb3-3835-4781-929f-6b1c1643ddee',
  date: 'Fri, 12 Aug 2016 00:01:16 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/b5a963f0-cb65-4c2e-a072-0cd66310327c?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-08-12T00:01:15.4967128+00:00\",\r\n  \"status\": \"InProgress\",\r\n  \"name\": \"b5a963f0-cb65-4c2e-a072-0cd66310327c\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '134',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': 'f3da5602-0501-4389-b8b8-9537f1a33e85',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14960',
  'x-ms-correlation-request-id': '2181f236-6b8b-4789-82a4-5760011119f3',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000148Z:2181f236-6b8b-4789-82a4-5760011119f3',
  date: 'Fri, 12 Aug 2016 00:01:47 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Compute/locations/eastus/operations/b5a963f0-cb65-4c2e-a072-0cd66310327c?api-version=2016-03-30')
  .reply(200, "{\r\n  \"startTime\": \"2016-08-12T00:01:15.4967128+00:00\",\r\n  \"endTime\": \"2016-08-12T00:01:47.6844169+00:00\",\r\n  \"status\": \"Succeeded\",\r\n  \"name\": \"b5a963f0-cb65-4c2e-a072-0cd66310327c\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '184',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '67130e5b-9ba3-4797-aae2-a53858198010',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14965',
  'x-ms-correlation-request-id': 'e6bb173a-2602-46c9-8b51-7357092690af',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000219Z:e6bb173a-2602-46c9-8b51-7357092690af',
  date: 'Fri, 12 Aug 2016 00:02:18 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://management.azure.com:443')
  .get('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension8009/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent?api-version=2016-03-30')
  .reply(200, "{\r\n  \"properties\": {\r\n    \"publisher\": \"Microsoft.Compute\",\r\n    \"type\": \"VMAccessAgent\",\r\n    \"typeHandlerVersion\": \"2.0\",\r\n    \"autoUpgradeMinorVersion\": true,\r\n    \"provisioningState\": \"Succeeded\"\r\n  },\r\n  \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplatTestGExtension8009/providers/Microsoft.Compute/virtualMachines/xplatvmExt/extensions/VMAccessAgent\",\r\n  \"name\": \"VMAccessAgent\",\r\n  \"type\": \"Microsoft.Compute/virtualMachines/extensions\",\r\n  \"location\": \"eastus\"\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '502',
  'content-type': 'application/json; charset=utf-8',
  ...
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-ms-served-by': 'f1952173-7412-4020-8c98-fffca6509750_131118073625769552',
  'x-ms-request-id': '3fee7355-0cf3-41d8-ad8a-c82a651d6196',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14970',
  'x-ms-correlation-request-id': 'bae44525-cce6-433b-aec2-2f3111b844aa',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T000220Z:bae44525-cce6-433b-aec2-2f3111b844aa',
  date: 'Fri, 12 Aug 2016 00:02:19 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
