...
.put('/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplat-test-lb-rule/providers/Microsoft.Network/loadBalancers/test-lb?api-version=2016-03-30', '*')
  .reply(200, "{\r\n  \"name\": \"test-lb\",\r\n  \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplat-test-lb-rule/providers/Microsoft.Network/loadBalancers/test-lb\",\r\n  \"etag\": \"W/\\\"53b5c8cb-9ca9-40b6-8208-1f3c7d6e6ac9\\\"\",\r\n  \"type\": \"Microsoft.Network/loadBalancers\",\r\n  \"location\": \"eastus\",\r\n  \"properties\": {\r\n    \"provisioningState\": \"Succeeded\",\r\n    \"resourceGuid\": \"92c1a5b0-a9c5-4710-b6ad-cc9edb62f301\",\r\n    \"frontendIPConfigurations\": [\r\n      {\r\n        \"name\": \"test-fip\",\r\n        \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplat-test-lb-rule/providers/Microsoft.Network/loadBalancers/test-lb/frontendIPConfigurations/test-fip\",\r\n        \"etag\": \"W/\\\"53b5c8cb-9ca9-40b6-8208-1f3c7d6e6ac9\\\"\",\r\n        \"properties\": {\r\n          \"provisioningState\": \"Succeeded\",\r\n          \"privateIPAllocationMethod\": \"Dynamic\",\r\n          \"publicIPAddress\": {\r\n            \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplat-test-lb-rule/providers/Microsoft.Network/publicIPAddresses/test-ip\"\r\n          }\r\n        }\r\n      }\r\n    ],\r\n    \"backendAddressPools\": [\r\n      {\r\n        \"name\": \"test-address-pool\",\r\n        \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplat-test-lb-rule/providers/Microsoft.Network/loadBalancers/test-lb/backendAddressPools/test-address-pool\",\r\n        \"etag\": \"W/\\\"53b5c8cb-9ca9-40b6-8208-1f3c7d6e6ac9\\\"\",\r\n        \"properties\": {\r\n          \"provisioningState\": \"Succeeded\"\r\n        }\r\n      }\r\n    ],\r\n    \"loadBalancingRules\": [],\r\n    \"probes\": [\r\n      {\r\n        \"name\": \"test-probe\",\r\n        \"id\": \"/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/resourceGroups/xplat-test-lb-rule/providers/Microsoft.Network/loadBalancers/test-lb/probes/test-probe\",\r\n        \"etag\": \"W/\\\"53b5c8cb-9ca9-40b6-8208-1f3c7d6e6ac9\\\"\",\r\n        \"properties\": {\r\n          \"provisioningState\": \"Succeeded\",\r\n          \"protocol\": \"Tcp\",\r\n          \"port\": 80,\r\n          \"intervalInSeconds\": 15,\r\n          \"numberOfProbes\": 2\r\n        }\r\n      }\r\n    ],\r\n    \"inboundNatRules\": [],\r\n    \"outboundNatRules\": [],\r\n    \"inboundNatPools\": []\r\n  }\r\n}", { 'cache-control': 'no-cache',
  pragma: 'no-cache',
  'content-length': '2159',
  'content-type': 'application/json; charset=utf-8',
  expires: '-1',
  'x-ms-request-id': 'd9404526-93cf-4739-abd9-aed9b93f5a8d',
  'azure-asyncoperation': 'https://management.azure.com/subscriptions/2c224e7e-3ef5-431d-a57b-e71f4662e3a6/providers/Microsoft.Network/locations/eastus/operations/d9404526-93cf-4739-abd9-aed9b93f5a8d?api-version=2016-03-30',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-writes': '1185',
  'x-ms-correlation-request-id': 'c41db583-6bc7-45d0-8966-0bbd4003e905',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T013648Z:c41db583-6bc7-45d0-8966-0bbd4003e905',
  date: 'Fri, 12 Aug 2016 01:36:48 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  etag: 'W/"53b5c8cb-9ca9-40b6-8208-1f3c7d6e6ac9"',
  'x-ms-request-id': 'cbcce28a-b147-4722-86d6-3e50fd9c6980',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14943',
  'x-ms-correlation-request-id': '1dfb0d54-9346-4748-98c3-b7e0aac1575a',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T013649Z:1dfb0d54-9346-4748-98c3-b7e0aac1575a',
  date: 'Fri, 12 Aug 2016 01:36:48 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  etag: 'W/"53b5c8cb-9ca9-40b6-8208-1f3c7d6e6ac9"',
  'x-ms-request-id': 'ef320721-078a-4460-a0ad-4b5499201309',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14951',
  'x-ms-correlation-request-id': '2a52c69a-b046-461e-88be-d4a8f51c3687',
  'x-ms-routing-request-id': 'CANADAEAST:20160812T013651Z:2a52c69a-b046-461e-88be-d4a8f51c3687',
  date: 'Fri, 12 Aug 2016 01:36:50 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
