...
nock('https://gallery.azure.com:443')
  ...
  'set-cookie': [ 'browserId=f89ff0e7adad4e26a5bc2edab0e6941e; domain=gallery.azure.com; path=/; secure; HttpOnly' ],
  'x-aspnet-version': '4.0.30319',
  'x-powered-by': 'ASP.NET',
  date: 'Tue, 14 Apr 2015 19:43:25 GMT',
  'content-length': '2978' });
 return result; },
function (nock) { 
var result = 
nock('https://management.azure.com:443')
  .get('/subscriptions/38b598fc-e57a-423f-b2e7-dc0ddb631f1f/resourcegroups/xDeploymentTestGroup8920/deployments/random_deployment_name?api-version=2014-04-01-preview')
  ...
  'x-ms-ratelimit-remaining-subscription-reads': '31847',
  'x-ms-request-id': '03ed935b-7d2b-4cfd-919d-4a71cf01e4cd',
  'x-ms-correlation-request-id': '03ed935b-7d2b-4cfd-919d-4a71cf01e4cd',
  'x-ms-routing-request-id': 'WESTUS:20150414T194325Z:03ed935b-7d2b-4cfd-919d-4a71cf01e4cd',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  date: 'Tue, 14 Apr 2015 19:43:25 GMT',
  'content-length': '107' });
 return result; }]];