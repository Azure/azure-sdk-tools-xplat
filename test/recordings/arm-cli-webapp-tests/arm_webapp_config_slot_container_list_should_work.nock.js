...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '2918b3ce-4f71-49f8-bc7b-e27f531db233',
  server: 'Microsoft-IIS/8.0',
  'x-aspnet-version': '4.0.30319',
  'x-powered-by': 'ASP.NET',
  'x-ms-ratelimit-remaining-subscription-resource-requests': '11999',
  'x-ms-correlation-request-id': 'd4889c44-29a2-44ea-8861-7e7fb59571af',
  'x-ms-routing-request-id': 'WESTUS2:20161020T210956Z:d4889c44-29a2-44ea-8861-7e7fb59571af',
  date: 'Thu, 20 Oct 2016 21:09:55 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
