...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': '8b5b4a90-9d44-4d4a-925b-128092e5380f',
  server: 'Microsoft-IIS/8.0',
  'x-aspnet-version': '4.0.30319',
  'x-powered-by': 'ASP.NET',
  'x-ms-ratelimit-remaining-subscription-reads': '14997',
  'x-ms-correlation-request-id': '849ed16d-d4fd-427b-861d-7e0dd0087eaf',
  'x-ms-routing-request-id': 'CENTRALUS:20161017T182435Z:849ed16d-d4fd-427b-861d-7e0dd0087eaf',
  date: 'Mon, 17 Oct 2016 18:24:34 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
