...
Account.prototype._getArmClient = function (credentials) {
  var client = new this._resourceClient.SubscriptionClient(credentials);
  if (this._env.resourceManagerEndpointUrl) {
    client = new this._resourceClient.SubscriptionClient(credentials, this._env.resourceManagerEndpointUrl);
  }
  return client;
};
