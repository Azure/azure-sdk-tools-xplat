...
function createService (serviceFactoryName, subscription, logger) {
  var pem = subscription.managementCertificate;
...
exports._createWebsiteClient = function (subscription, logger) {
  return exports._createService('_createWebsiteManagementClient', subscription, logger);
};

exports._createSqlClient = function (subscription, logger) {
  return exports._createService('_createSqlManagementClient', subscription, logger);
};

exports._createServiceBusClient = function (subscription, logger) {
  return exports._createService('_createServiceBusManagementClient', subscription, logger);
};

exports._createManagementClient = function (subscription, logger) {
  return exports._createService('_createManagementClient', subscription, logger);
};

exports._createStorageClient = function (subscription, logger) {
  return exports._createService('_createStorageManagementClient', subscription, logger);
};

exports._createComputeClient = function (subscription, logger) {
  return exports._createService('_createComputeManagementClient', subscription, logger);
};

function createLogFilter(logger) {
  return function handle (resource, next, callback) {
    logger.silly('requestOptions');
    logger.json('silly', resource);

    return next(resource, function (err, response, body) {
      logger.silly('returnObject');
      if (response) {
        logger.json('silly', {
