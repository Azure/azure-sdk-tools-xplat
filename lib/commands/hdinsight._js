...
var hdInsightCommandLine = function(cli, userInteractor, executionProcessor) {
  ...
  this.createClusterCommand = function (config, options, _) {
    ...
    if (options.version) {
      creationObject.version = options.version;
    }
...
hdInsightCommandLine.init = function (cli) {
  ...
  cluster.command('create [config]')
	...
	.option('--version <clusterVersion>', 'The HdInsight cluster version')
  ...
  var storage = config.category('storage')
    .description('Commands to manage your HDInsight storage acounts in a configuration file');
  ...
  var metastore = config.category('metastore')
    .description('Commands to manage your HDInsight metastore acounts in a configuration file');
