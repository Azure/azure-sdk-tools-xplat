  ...
  */
  ...
  mobile.command('create [servicename] [username] [password]')
        ...
        .execute(function (servicename, username, password, options, _) {
          ...
          options.servicename = interaction.promptIfNotGiven(cli, 'Mobile service name: ', servicename, _);
  ...
  mobile.command('delete [servicename]')
        ...
        .execute(function (servicename, username, password, options, _) {
          ...
          var progress = cli.progress('Retrieving mobile service details');
          var result;
          try {
          ...
          if (!options.quiet) {
            var proceed = interaction.confirm(cli, 'Do you want to delete the mobile service' + prompt + '? [y/n]: ', _);
            if (!proceed) {
  ...
  mobile.command('list')
        ...
        .execute(function (options, _) {
          var progress = cli.progress('Retrieving list of mobile services');
          var result;
          try {
          ...
          interaction.formatOutput(cli, result, function (services) {
  ...
  mobile.command('restart [servicename]')
        ...
        .execute(function (servicename, options, _) {
          ...
          var progress = cli.progress('Restarting mobile service: \'' + options.servicename + '\'');
          var result;
          try {
  ...
  mobileScript.command('download [servicename] [scriptname]')
        ...
        .execute(function (servicename, scriptname, options, _) {
          ...
          var progress = cli.progress(util.format($('Downloading script: \'%s\''), options.scriptname));
          var script;
          try {
  ...
  mobileScript.command('upload [servicename] [scriptname]')
        ...
        .execute(function (servicename, scriptname, options, _) {
          ...
          var progress = cli.progress(util.format($('Uploading script: \'%s\''), options.scriptname));
          try {
  ...
  mobileScript.command('delete [servicename] [scriptname]')
        ...
        .execute(function (servicename, scriptname, options, _) {
          ...
          var progress = cli.progress(util.format($('Deleting script: \'%s\''), options.scriptname));
          try {
  ...
  mobilePreview.command('list [servicename]')
        ...
        .execute(function (servicename, options, _) {
          ...
          var progress = cli.progress('Retrieving preview features');
          var result;
          try {
          ...
          interaction.formatOutput(cli, result, function (features) {
  ...
  mobileApi.command('create [servicename] [apiname]')
        ...
        .execute(function (servicename, apiname, options, _) {
          ...
          // Now create the API
          var progress = cli.progress(util.format($('Creating custom API: \'%s\')'), options.apiname));
          try {
  ...
  mobileApi.command('update [servicename] [apiname]')
        ...
        .execute(function (servicename, apiname, options, _) {
          ...
          var settings = parsePermissions(options.permissions, methods);
          var progress = cli.progress(util.format($('Updating API: \'%s\''), options.apiname));
  ...
  mobileApi.command('delete [servicename] [apiname]')
        ...
        .execute(function (servicename, apiname, options, _) {
          ...
          var progress = cli.progress(util.format($('Deleting API: \'%s\''), options.apiname));
          try {
