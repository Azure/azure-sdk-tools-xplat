...
function getVMSize(options, logger, callback) {
  ...
  if (options.vmSize) {
    ...
    if (vmSize !== 'ExtraSmall' && vmSize !== 'Small' && vmSize !== 'Medium' &&
      ...
      vmSize !== 'Basic_A1' && vmSize !== 'Basic_A2' && vmSize !== 'Basic_A3' && vmSize !== 'Basic_A4') {
      logger.help('--vm-size <size> must specify one of the following:');
      logger.help('  extrasmall, small, medium, large, extralarge, a5, a6, a7, a8, a9, basic_a1, basic_a2, basic_a3, basic_a4  ');
