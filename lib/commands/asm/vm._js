...
exports.init = function(cli) {
  ...
  disk.command('attach <vm-name> <disk-image-name>')
    ...
    .option('-h, --host-caching <name>', $('the caching behaviour of disk [None, ReadyOnly, ReadWrite]'))
    .option('-d, --dns-name <name>', $('filter VMs for the specified DNS name'))
    .option('-s, --subscription <id>', $('the subscription id'))
  ...
  disk.command('attach-new <vm-name> <size-in-gb> [blob-url]')
    ...
    .option('-h, --host-caching <name>', $('the caching behaviour of disk [None, ReadOnly, ReadWrite]'))
    .option('-d, --dns-name <name>', $('filter VMs for the specified DNS name'))
    .option('-s, --subscription <id>', $('the subscription id'))
