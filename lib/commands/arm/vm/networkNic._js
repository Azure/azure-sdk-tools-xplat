...
__.extend(NetworkNic.prototype, {
    createOrUpdateNICIfRequired: function(_) {
      ...
      if (nicInfo.profile) {
        ...
        nicInfo = this.getNICInfoByName(createInfo.vnetInfo.subnetInfo.resourceGroupName, nicInfo.nicName, _);
    ...
    _createNewNIC: function (resourceGroupName, params, _) {
      ...
      try {
        this.networkResourceProviderClient.networkInterfaces.createOrUpdate(ipConfigInfo.vnetInfo.subnetInfo.resourceGroupName, params.nicName, createRequestProfile, _);
      } finally {
        progress.end();
      }
