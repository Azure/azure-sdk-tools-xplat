...
exports.init = function (cli) {
  ...
  container.command('set [resource-group] [name]')
    ...
    .execute(function (resourceGroup, name, options, _) {
      ...
      currentAppSettings.location = result.location;
      try {
  ...
  container.command('delete [resource-group] [name]')
    ...
    .execute(function (resourceGroup, name, options, _) {
      ...
      if (currentAppSettings.properties.hasOwnProperty('DOCKER_REGISTRY_SERVER_URL'))
      {
        delete currentAppSettings.properties['DOCKER_REGISTRY_SERVER_URL'];
      }
      if (currentAppSettings.properties.hasOwnProperty('DOCKER_REGISTRY_SERVER_USERNAME')) {
        delete currentAppSettings.properties['DOCKER_REGISTRY_SERVER_USERNAME'];
      }
      if (currentAppSettings.properties.hasOwnProperty('DOCKER_REGISTRY_SERVER_PASSWORD')) {
        delete currentAppSettings.properties['DOCKER_REGISTRY_SERVER_PASSWORD'];
      }
      if (currentAppSettings.properties.hasOwnProperty('DOCKER_CUSTOM_IMAGE_NAME')) {
