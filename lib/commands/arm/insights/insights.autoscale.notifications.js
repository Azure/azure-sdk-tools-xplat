...
exports.init = function (cli) {
  ...
  insightsAlertsWebhookActionsCommand._prepareAndExecuteWebhook = function (options) {
  ...
  insightsAlertsWebhookActionsCommand.command('create <serviceUri>')
      ...
      .execute(function (serviceUri, options, _) {
        ...
        options.serviceUri = options.serviceUri || serviceUri;
        if (!__.isString(options.serviceUri)) {
          return cli.missingArgument('serviceUri');
        }

        insightsAlertsWebhookActionsCommand._prepareAndExecuteWebhook(options);
      });
};
