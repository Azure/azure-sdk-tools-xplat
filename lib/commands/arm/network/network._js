...
exports.init = function (cli) {
  ...
  nicAddressPool.command('add [resource-group] [name]')
    ...
    .execute(function (resourceGroup, name, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var nic = new Nic(cli, networkManagementClient);
      nic.addBackendAddressPool(resourceGroup, name, options, _);
    });
  ...
  nicAddressPool.command('remove [resource-group] [name]')
    ...
    .execute(function (resourceGroup, name, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var nic = new Nic(cli, networkManagementClient);
      nic.removeBackendAddressPool(resourceGroup, name, options, _);
    });
  ...
  nicInboundRule.command('add [resource-group] [name]')
    ...
    .execute(function (resourceGroup, name, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var nic = new Nic(cli, networkManagementClient);
      nic.addInboundNatRule(resourceGroup, name, options, _);
    });
  ...
  nicInboundRule.command('remove [resource-group] [name]')
    ...
    .execute(function (resourceGroup, name, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var nic = new Nic(cli, networkManagementClient);
      nic.removeInboundNatRule(resourceGroup, name, options, _);
    });
  ...
  vpnGatewayRootCert.command('add [resource-group] [name] [cert-name]')
    ...
    .execute(function (resourceGroup, name, certName, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var vnetGateway = new VirtualNetworkGateway(cli, networkManagementClient);
      vnetGateway.addRootCert(resourceGroup, name, certName, options, _);
    });

  vpnGatewayRootCert.command('remove [resource-group] [name] [cert-name]')
    .description($('Remove a root certificate from a virtual network gateway'))
    .usage('[options] <resource-group> <name> <cert-name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-n, --name <name>', $('the name of the virtual network gateway'))
    .option('-c, --cert-name <cert-name>', $('the name of the root certificate'))
    ...
    .execute(function (resourceGroup, name, certName, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var vnetGateway = new VirtualNetworkGateway(cli, networkManagementClient);
      vnetGateway.removeRootCert(resourceGroup, name, certName, options, _);
    });
  ...
  vpnGatewayRevokedCert.command('add [resource-group] [name] [cert-name]')
    ...
    .execute(function (resourceGroup, name, certName, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var vnetGateway = new VirtualNetworkGateway(cli, networkManagementClient);
      vnetGateway.addRevokedCert(resourceGroup, name, certName, options, _);
    });

  vpnGatewayRevokedCert.command('remove [resource-group] [name] [cert-name]')
    .description($('Remove a revoked certificate from a virtual network gateway'))
    .usage('[options] <resource-group> <name> <cert-name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-n, --name <name>', $('the name of the virtual network gateway'))
    .option('-c, --cert-name <cert-name>', $('the name of the revoked certificate'))
    ...
    .execute(function (resourceGroup, name, certName, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var vnetGateway = new VirtualNetworkGateway(cli, networkManagementClient);
      vnetGateway.removeRevokedCert(resourceGroup, name, certName, options, _);
    });
  ...
  appGatewayProbe.command('add [resource-group] [gateway-name] [name]')
  ...
  appGatewayProbe.command('remove [resource-group] [gateway-name] [name]')
  ...
  appGatewayUrlPathMap.command('add [resource-group] [gateway-name] [name]')
  ...
  appGatewayUrlPathMap.command('remove [resource-group] [gateway-name] [name]')
  ...
  mapRule.command('add [resource-group] [gateway-name] [name]')
    .description($('Add url path map to application gateway'))
    .usage('[options] <resource-group> <gateway-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-w, --gateway-name <gateway-name>', $('the name of the application gateway'))
  ...
  mapRule.command('remove [resource-group] [gateway-name] [name]')
    .description($('Delete an url path map from an application gateway'))
    .usage('[options] <resource-group> <gateway-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-w, --gateway-name <gateway-name>', $('the name of the application gateway'))
