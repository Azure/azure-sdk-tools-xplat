...
exports.init = function (cli) {
  ...
  expressRouteAuthorization.command('create [resource-group] [circuit-name] [name]')
    ...
    .option('-n, --name <name>', $('the name of the express route circuit authorization'))
    ...
    .execute(function (resourceGroup, circuitName, name, options, _) {
      ...
      name = cli.interaction.promptIfNotGiven($('Express route express route authorization name: '), name, _);
      options.key = cli.interaction.promptIfNotGiven($('Express route authorization key: '), options.key, _);

      var networkManagementClient = getNetworkManagementClient(options);
      var expressRoute = new ExpressRoute(cli, networkManagementClient);
      expressRoute.createAuthorization(resourceGroup, circuitName, name, options, _);
    });

  expressRouteAuthorization.command('set [resource-group] [circuit-name] [name]')
    ...
    .execute(function (resourceGroup, circuitName, name, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      circuitName = cli.interaction.promptIfNotGiven($('Express route circuit name: '), circuitName, _);
      name = cli.interaction.promptIfNotGiven($('Express route authorization name: '), name, _);

      var networkManagementClient = getNetworkManagementClient(options);
      var expressRoute = new ExpressRoute(cli, networkManagementClient);
      expressRoute.setAuthorization(resourceGroup, circuitName, name, options, _);
    });

  expressRouteAuthorization.command('show [resource-group] [circuit-name] [name]')
    .description($('Show express route circuit authorization'))
    .usage('[options] <resource-group> <circuit-name> <name>')
    .option('-g, --resource-group <resource-group>', $('the name of the resource group'))
    .option('-c, --circuit-name <circuit-name>', $('the name of the express route circuit'))
    .option('-n, --name <name>', $('the name of the express route circuit express route authorization'))
    .option('-s, --subscription <subscription>', $('the subscription identifier'))
    .execute(function (resourceGroup, circuitName, name, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('Resource group name: '), resourceGroup, _);
      circuitName = cli.interaction.promptIfNotGiven($('Express route circuit name: '), circuitName, _);
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var expressRoute = new ExpressRoute(cli, networkManagementClient);
      expressRoute.showAuthorization(resourceGroup, circuitName, name, options, _);
    });

  expressRouteAuthorization.command('delete [resource-group] [circuit-name] [name]')
    ...
    .execute(function (resourceGroup, circuitName, name, options, _) {
      ...
      var networkManagementClient = getNetworkManagementClient(options);
      var expressRoute = new ExpressRoute(cli, networkManagementClient);
      expressRoute.deleteAuthorization(resourceGroup, circuitName, name, options, _);
    });
