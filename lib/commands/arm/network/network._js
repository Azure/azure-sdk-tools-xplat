...
exports.init = function (cli) {
  ...
  appGateway.command('create [resource-group] [name] [location]')
    ...
    .option('-t, --routing-rule-type <routing-rule-type>',  util.format($('the request routing rule type, default is "%s"'), constants.appGateway.routingRule.type[0]))
