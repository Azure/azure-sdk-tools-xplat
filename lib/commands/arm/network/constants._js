...
module.exports = {
  ...
  dnsZone: {
    ...
    recordClasses: ['IN'],
    setTypes: ['A', 'AAAA', 'MX', 'NS', 'SRV', 'TXT', 'CNAME'], // PTR is not supported yet
    recordTypes: ['SOA', 'A', 'AAAA', 'CNAME', 'MX', 'NS', 'SRV', 'TXT', 'PTR'], // PTR is not supported yet
    restrictedRecordTypes: ['A', 'AAAA', 'CNAME', 'MX', 'NS', 'SRV', 'TXT', 'PTR'], // PTR is not supported yet
    A: 'A',
    AAAA: 'AAAA',
    CNAME: 'CNAME',
    MX: 'MX',
