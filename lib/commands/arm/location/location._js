...
exports.init = function (cli) {
  ...
  group.command('list')
    ...
    clientA.subscriptions.listLocations(subscription.id, function (err, result) {
      if (err) {
        return callback(err);
      }
